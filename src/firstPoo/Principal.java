...
if (age>=18) {
	...
	unMaj.setPrenom(aff.saisir("Saisir votre pr�nom : "));
	...
	enf.setPrenom(aff.saisir("Saisir votre pr�nom : "));
	...
	adoo.setPrenom(aff.saisir("Saisir votre pr�nom : "));
	...
	aff.afficher(adoo.toString());
		...
		// autre instance de Personne
		Personne nicolas = new Personne(aff.saisir("Saisir votre nom : "), aff.saisir("Saisir votre pr�nom : "), 34);
